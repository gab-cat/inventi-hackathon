...
export const webGetMessagesByThreadIdArgs = {
  threadId: v.id('chatThreads'),
  limit: v.optional(v.number()),
  cursor: v.optional(v.string()),
};

export const webGetMessagesByThreadIdReturns = v.object({
  messages: v.array(
    v.object({
      _id: v.id('messages'),
...
export const webGetMessagesByThreadIdHandler = async (ctx: any, args: any) => {
...
export type GetMessagesByThreadIdArgs = typeof webGetMessagesByThreadIdArgs;
export type GetMessagesByThreadIdReturns = typeof webGetMessagesByThreadIdReturns;
export type GetMessagesByThreadIdHandler = typeof webGetMessagesByThreadIdHandler;
