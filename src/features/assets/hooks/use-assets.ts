...
export function useAssets(filters: AssetFilters & { propertyId?: Id<'properties'> }) {
  return useAuthenticatedQuery(api.assets.getAssets, {
...
export function useAssetById(assetId: Id<'assets'>) {
  return useAuthenticatedQuery(api.assets.getAssetById, { assetId });
}

export function useAssetHistory(assetId: Id<'assets'>) {
  return useAuthenticatedQuery(api.assets.getAssetHistory, {
...
export function useAssetDashboard(propertyId?: Id<'properties'>) {
  return useAuthenticatedQuery(api.assets.getAssetDashboardData, { propertyId });
}

export function useAssetAlerts(propertyId?: Id<'properties'>) {
  return useAuthenticatedQuery(api.assets.getAssetAlerts, { propertyId });
}

export function useManagerProperties() {
  return useAuthenticatedQuery(api.assets.getManagerProperties, {});
}
