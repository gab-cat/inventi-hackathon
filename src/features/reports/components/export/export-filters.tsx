    ...
    <Card>
      ...
      <CardContent className='space-y-6'>
              ...
              <div className='flex flex-wrap gap-1'>
                {filters.conditions.map(condition => (
                  <Badge key={condition} variant='secondary' className='flex items-center gap-1'>
                    {condition}
                    <X className='h-3 w-3 cursor-pointer' onClick={() => removeArrayFilter('conditions', condition)} />
                  </Badge>
                ))}
              </div>
            )}
        ...
        <div className='flex items-center space-x-2'>
          <Checkbox id='advanced' checked={showAdvanced} onCheckedChange={setShowAdvanced} />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  onCheckedChange={checked => updateFilter('maintenanceDue', checked)}
                />
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  onCheckedChange={checked => updateFilter('warrantyExpiring', checked)}
                />
